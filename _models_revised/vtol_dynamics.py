...
class VtolDynamics:
    ...
    def sensors(self):
        ...
        specific_acceleration = R_b_i.T @ (self._forces/VTOL.mass - VTOL.gravity * e3)
        ...
        self._sensors.abs_pressure = -VTOL.rho * VTOL.gravity * self._state.item(2) \
    ...
    def _forces_moments(self, delta):
        ...
        :return: Forces and torques on the VTOL np.matrix(Fx, Fy, Fz, Mx, My, Mz)
        """
