...
from tools.rotations import euler_to_quaternion, euler_to_rotation
...
class airsimDemo:
    ...
    def new_vehicle_pose(self, state_update):
        ...
        quat = euler_to_quaternion(state_update.phi, state_update.theta, state_update.psi)
    ...
    def new_follower_pose(self, vehicle_state):
        ...
        R_l2b = euler_to_rotation(vehicle_state.phi, vehicle_state.theta, 0.).T
        ...
        quat = euler_to_quaternion(self.follower_roll - vehicle_state.phi, self.follower_pitch - vehicle_state.theta, 0.)
