...
def main():
    ...
    while sim_time < SIM.end_time:
        #-------observer-------------
        measurements = quad.sensors()  # get sensor measurements
        ...
        vtol_view.update(quad.true_state)
        state_view.update(quad.true_state, quad.true_state, desired_state, delta, Ts)
