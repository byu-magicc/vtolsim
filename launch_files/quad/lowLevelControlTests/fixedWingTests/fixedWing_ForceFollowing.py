...
#gets the error vector from the control function
errorArray = lowLevelController.getWrenchError()

df = pd.DataFrame(data=errorArray)

df.to_csv("/home/dben1182/Documents/vtolsim/launch_files/quad/lowLevelControlTests/fixedWingTests/lowLevelControl_Outputs/wrenchError.csv", header=False, index=False)
