...
class VtolDynamics:
    ...
    def _forces_moments(self, delta):
        ...
        #print("Rear F and M: %f, %f" % (Thrust,Moment))
        # Thrust = delta.throttle_rear*VTOL.k_force
        # Moment = delta.throttle_rear*VTOL.k_moment
        ...
        #print("Right F and M: %f, %f" % (Thrust,Moment))
        # Thrust = delta.throttle_right*VTOL.k_force
        # Moment = delta.throttle_right*VTOL.k_moment
        ...
        #print("Left F and M: %f, %f" % (Thrust,Moment))
        # Thrust = delta.throttle_left*VTOL.k_force
        # Moment = -delta.throttle_left*VTOL.k_moment
